...
public final class Strings {
    ...
    public static String requireNonNullNorEmpty(String str, StringExceptionsDefault stringExceptionsDefault) {
        str = Strings.requireNonNullNorEmptyPrivate(str, stringExceptionsDefault, StringExceptionsValidationMessages.DEFAULT.instanceName);
        return str;
    }

    public static String requireNonNullNorWhitespace(String str, StringExceptionsDefault stringExceptionsDefault) {
        str = Strings.requireNonNullNorWhitespacePrivate(str, stringExceptionsDefault, StringExceptionsValidationMessages.DEFAULT.instanceName);
        return str;
    }
    ...
    public static String requireNonNullNorEmpty(String str, StringExceptionsDefaultWithMessage stringExceptionsDefaultWithMessage) {
        str = Strings.requireNonNullNorEmptyPrivate(str, stringExceptionsDefaultWithMessage, StringExceptionsValidationMessages.DEFAULT_WITH_MESSAGE.instanceName);
        return str;
    }
    ...
    public static String requireNonNullNorWhitespace(String str, StringExceptionsDefaultWithMessage stringExceptionsDefaultWithMessage) {
        str = Strings.requireNonNullNorWhitespacePrivate(str, stringExceptionsDefaultWithMessage, StringExceptionsValidationMessages.DEFAULT_WITH_MESSAGE.instanceName);
        return str;
    }
    ...
    public static String requireNonNullNorEmpty(String str, StringExceptionsDefaultWithMessageSupplier stringExceptionsDefaultWithMessageSupplier) {
        str = Strings.requireNonNullNorEmptyPrivate(str, stringExceptionsDefaultWithMessageSupplier, StringExceptionsValidationMessages.DEFAULT_WITH_MESSAGE_SUPPLIER.instanceName);
        return str;
    }
    ...
    public static String requireNonNullNorWhitespace(String str, StringExceptionsDefaultWithMessageSupplier stringExceptionsDefaultWithMessageSupplier) {
        str = Strings.requireNonNullNorWhitespacePrivate(str, stringExceptionsDefaultWithMessageSupplier, StringExceptionsValidationMessages.DEFAULT_WITH_MESSAGE_SUPPLIER.instanceName);
        return str;
    }
    ...
    public static <E1 extends Throwable, E2 extends Throwable, E3 extends Throwable> String requireNonNullNorEmptyElseThrow(String str, StringExceptionsCustom<E1, E2, E3> stringExceptionsCustom) throws E1, E2 {
        str = Strings.requireNonNullNorEmptyPrivate(str, stringExceptionsCustom, StringExceptionsValidationMessages.CUSTOM.instanceName);
        return str;
    }
    ...
    public static <E1 extends Throwable, E2 extends Throwable, E3 extends Throwable> String requireNonNullNorWhitespaceElseThrow(String str, StringExceptionsCustom<E1, E2, E3> stringExceptionsCustom) throws E1, E2, E3 {
        str = Strings.requireNonNullNorWhitespacePrivate(str, stringExceptionsCustom, StringExceptionsValidationMessages.CUSTOM.instanceName);
        return str;
    }
